...
//   - either input may be empty (mergeSorted([], []) is [], mergeSorted([], [1]) is [1])
//   - duplicates are kept (mergeSorted([1, 1], [1]) is [1, 1, 1])
//   - the inputs may differ in length
//   - neither input array is modified; only reads and a fresh result array are used
