...
applicable; **C** 4/4 proven (C3 with its tooth owed); **D** 11 proven (D7, D8, D9 included), 0 partly; **E** excluded by the design; **F** not started; **G** 2 proven (G1, G2), 2 partly (G4, G6), 3 owed (G3, G5, G7).
