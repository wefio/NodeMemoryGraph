...
import { createEmbeddingClientFromEnv, NmgStore, UsearchAnnIndex } from "../src/index.ts";

const databasePath = resolve(process.env.NMG_DB_PATH ?? ".nmg/nmg.sqlite");
const embeddingClient = createEmbeddingClientFromEnv(process.env, { required: true })!;
