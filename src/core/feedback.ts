...
const FEEDBACK_STOPWORDS = new Set([
  "the", "and", "for", "that", "with", "was", "this", "his", "her", "you",
  "your", "they", "them", "are", "were", "from", "have", "has", "had", "not",
  "but", "all", "any", "can", "will", "would", "could", "about", "into", "than",
  "then", "when", "what", "which", "who", "whom", "whose", "where", "why", "how",
  "their", "there", "here", "just", "also", "some", "more", "most", "such", "only",
  "very", "been", "being", "did", "does", "doing", "done", "made", "make", "makes",
  "like", "said", "says", "want", "needs", "know", "really", "much", "many", "thing",
  "things", "stuff", "because", "since", "well", "even", "still", "both", "each",
]);
