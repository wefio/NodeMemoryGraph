...
function apply(ctx) {
	...
	const searchTool = {
		...
		async execute(args, exec) {
			...
			return renderSearchSurface(data, { preamble: renderDisclosure(nmgPrompts.search_disclosure, {
